...
async function main() {
  ...
  const report = { input, publication: "VALIDATION_ONLY", ...result.summary, errors: result.errors, duplicateRows: result.duplicateRows, duplicateGroups: result.duplicateGroups, databaseComparison: "Upload this CSV in Club → Products & Pricing for authenticated proposed creates, updates, retirements, cost changes and retained manual prices." };
