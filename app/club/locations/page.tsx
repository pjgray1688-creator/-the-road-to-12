...
export default async function ClubLocationsPage({ searchParams }: { searchParams?: Promise<{ org?: string }> }) {
  ...
  try {
    ...
    if (!context) return <AppShell className="module-page club-page"><PageHeader eyebrow="R12 CLUB" title="Locations" description="Location context is restricted to Club operations." /><EmptyState title="Club access required">Choose an authorised organisation.</EmptyState><BackButton href="/club">Back to Club</BackButton><AppNav /></AppShell>;
