...
async function loadShop(client: Awaited<ReturnType<typeof serverSupabase>>, userId: string, organisationId?: string, locationId?: string) {
  ...
  return { organisation, products, families, locations: authorisedLocations, activeLocation, stockBalances, balance, orders, declarations, customers, deliveries, promotions, staff, canRecordCash, canReconcile, canAdjustStock, canRemoveStock, canManageCatalogue, role: member.role, contexts: context.availableContexts };
}
