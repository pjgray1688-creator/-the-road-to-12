...
export default async function MemberHubPage() {
  ...
  return <><div className="member-hub-section" style={{ padding: 16 }}><Link className="member-hub-link primary" href="/member-hub/glow-zone"><strong>GLOW ZONE</strong><small>Sunbeds at Madhouse Carlton · View packages and minutes</small></Link></div><MemberHub data={loaded} /></>;
}
