...
export default function OnboardingPage() {
  const router = useRouter(); const [step, setStep] = useState(0); const [profile, setProfile] = useState<TrainingProfile>(defaultTrainingProfile); const [programme, setProgramme] = useState<GeneratedProgramme>(); const [message, setMessage] = useState("");
