...
export function ClubMembershipAssignment({ organisationId, userId, customerId, products }: { organisationId: string; userId?: string; customerId?: string; products: ClubProduct[] }) {
