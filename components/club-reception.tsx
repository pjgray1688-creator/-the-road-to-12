...
export function ClubReception({ organisationId, role, members, customers, products, locations, cashDeclarations, canAssign, canManageStaff = false, locationId }: { organisationId: string; role: ClubRole; members: ClubMemberSummaryRead[]; customers: ClubCustomer[]; products: ClubProduct[]; locations: OrganisationLocation[]; cashDeclarations: CashItem[]; canAssign: boolean; canManageStaff?: boolean; locationId?: string }) {
