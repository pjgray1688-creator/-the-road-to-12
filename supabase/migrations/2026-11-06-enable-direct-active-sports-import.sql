-- Enable the direct weekly supplier synchroniser for Active Sports.
-- This preserves the canonical v2 import behaviour and removes only the
-- obsolete Active Sports reconciliation prerequisite.
