...
export function taxonomyForExercise(exercise: Exercise): ExerciseTaxonomy {
  ...
  const inferred: Record<string, string[]> = { "hamstring-curl": ["hamstrings"], rdl: ["hamstrings", "glutes"], "trap-bar-deadlift": ["quads", "hamstrings", "glutes"], "leg-press": ["quads", "glutes"], "hack-squat": ["quads", "glutes"], "hoist-roc-it-leg-extension": ["quads"], calves: ["calves"], "flat-bench": ["chest"], "lat-pulldown": ["lats"], "barbell-row": ["upper back"], "rear-delt-fly": ["rear delts"], "cable-lateral-raise": ["lateral delts"], "hip-thrust": ["glutes"], "rope-triceps-pushdown": ["triceps"], "cable-crunch": ["abs"], "incline-db-press": ["upper chest"] };
