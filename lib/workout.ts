...
export const mondayExercises: Exercise[] = [
  ...
  { id: "cable-lateral-raise", name: "Cable Lateral Raise", target: "4 × 12–15", sets: 4, restSeconds: 60, purpose: "isolation", equipment: "cable", stackIncrement: 2.5, defaultWorkingWeight: 10 },
