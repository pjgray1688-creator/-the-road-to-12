...
export type ClubInductionStateRead = { state: ClubInductionState; required: boolean; /** The route actually completed/booked; unset while a member is merely due. */ route?: ClubInductionRoute; /** Routes currently offered by the active policy. */ availableRoutes?: ClubInductionRoute[]; policyId?: string; versionId?: string; dueAt?: string; graceRemainingDays?: number; booking?: ClubInductionBooking; completedAt?: string; verifiedBy?: string; accessEffect: "none" | "warn" | "hold"; requirement?: ClubInductionRequirement };
