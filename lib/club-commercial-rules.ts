...
export type ClubPromotionStatus = "draft" | "active" | "paused" | "expired" | "scheduled";
...
export type ClubCashDeclaration = { id: string; organisationId: string; locationId?: string; purpose: ClubCashDeclarationPurpose; userId?: string; customerId?: string; memberDisplayName?: string; memberEmail?: string; productSummary?: string; orderId?: string; membershipId?: string; declaredAmountMinor: number; currency: string; status: ClubCashDeclarationStatus; declaredAt: string; confirmedAt?: string; confirmedBy?: string; discrepancyMinor?: number; notes?: string; idempotencyKey?: string; createdAt: string; updatedAt: string };
...
export type ClubPromotion = { id: string; organisationId: string; name: string; description?: string; status: ClubPromotionStatus; startsAt: string; endsAt?: string; locationIds?: string[]; eligibility: Record<string, unknown>; createdBy: string; createdAt: string; updatedAt: string; targets?: ClubPromotionTarget[]; effects?: ClubPromotionEffect[] };
