...
export type ClubPromotion = { id: string; organisationId: string; name: string; description?: string; status: ClubPromotionStatus; startsAt: string; endsAt?: string; locationIds?: string[]; eligibility: Record<string, unknown>; createdBy: string; createdAt: string; updatedAt: string };
