...
export type Membership = { id: string; organisationId: string; productId: string; billingGroupId?: string; status: "active" | "paused" | "expired" | "cancelled"; validity: Validity; source: GrantSource; holderUserIds: string[]; holderCustomerIds?: string[]; assignmentIdempotencyKey?: string; endRequestedAt?: string; endRequestedBy?: string; endedAt?: string; endedBy?: string };
